"""
=====================================================================================
Logistic Regression and evaluation of Talos Hyperparameter Scan Binary Classification
=====================================================================================
Logistic Regression and evaluation of Talos Hyperparameter Scan Binary Classification
"""
import sys
...
class AnnMLPOptimiseEvaluateBinary:
    def __init__(self):
        self.logfile = None
    ...
    def load_hyp(self):
        self.hyp = pd.read_csv('tuning/Hyperparameter tuning - AnnMLPBinaryOptimize_1.csv')
...
evaluatebinary = AnnMLPOptimiseEvaluateBinary()
